...
def train():
    ...
    test_phrases = [
        ...
        "take a screenshot",
        "hello",
        "jarvis yaar open youtube",
        "bhai what is the time",
        "ek second mera schedule dekho",
        "weather kaisa hai aaj",
        "yaar play some music na",
        "bhai send message to rahul",
        "kya news hai aaj",
        "jarvis bata mujhe time",
        "chrome kholo",
        "screenshot le bhai",
        "volume badha do",
        "volume kam karo",
        "screen thodi bright karo",
        "play on youtube",
        "search and play despacito",
        "open youtube and search coding tutorials",
        "jarvis open youtube",
        "play on youtube",
        ...
        "play latest songs on youtube",
        "search for gaming videos youtube",
        ...
        "open a ted talk video",
        "youtube how to fix windows error",
